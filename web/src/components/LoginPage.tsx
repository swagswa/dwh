...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-950 p-4">
      ...
      {/* Card */}
      <div className="relative w-full max-w-[400px] rounded-xl bg-slate-900/60 p-8 shadow-2xl">
        {/* Header */}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="email"
                className="h-10 w-full rounded-lg border-0 bg-slate-800 pl-10 pr-3 text-sm text-white placeholder:text-slate-500 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
          </div>
